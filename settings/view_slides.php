...
?>
			<tr>
				...
				<td rowspan="4"><img src='../assets/images/<?php echo $foto; ?>' width='120px' height='80px' class="img border border-secondary"></td>				
      			...
      			<td rowspan="4"><input type='button' name='edit' id='<?php echo $slide_id; ?>' value='Edit' class='btn btn-sm btn-outline-pastel edit_slide'></td>
      			<td rowspan="4"><input type='button' name='hapus' id='<?php echo $slide_id; ?>' value='Hapus' class='btn btn-sm btn-outline-pastel hapus_slide'></td>
      		</tr>
      		<tr>
      			<td><?php echo $isi2; ?></td>	
      		</tr>
