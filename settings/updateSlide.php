  ...
  if(isset($_POST["slide_id"])) {
    ...
    if($_POST["slide_id"] != '') {
      ...
      if(!empty($_POST["checkBoxValue"])) { 
        ...
        $query = $pdo->prepare("UPDATE slides SET judul=?,isi1=?,isi2=?,isi3=?,isi4=?,slide_status=? WHERE slide_id=?");
        $query->execute([$judul,$isi1,$isi2,$isi3,$isi4,$slide_status,$_POST['slide_id']]); 
